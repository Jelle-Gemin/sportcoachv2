 ...
 */
export function calculateKarvonenZones(maxHR: number, restingHR: number) {
 ...
 */
export function calculateCogganZones(ftp: number) {
 ...
 */
export function calculateSwimZones(cssString: string) {
    if (!cssString) return [];
