...
export const weeklySchedule: AnyWorkout[] = [
    ...
    // -------------------- WED (RUN) --------------------
    {
        ...
        type: "Run",
        completed: true,
        title: "Key Session: Run Intervals",
        description: "Run: 8x400m @ 4:05/km.",
        duration: 2700,
        workout: {
            warmup: { time: 600 },
            main: {
    ...
    // -------------------- WED (BIKE) --------------------
    {
        ...
        type: "Bike",
        completed: true,
        title: "Key Session: Bike Intervals",
        description: "Sweet Spot Intervals. 2x10 min @ 88–90% FTP.",
        duration: 2700,
        workout: {
            warmup: { time: 600 },
            main: {
    ...
    // -------------------- SAT --------------------
    {
        ...
        description: "8x 2' @ 3:50-3:55 (rec: 2’ jog).",
        duration: 3000,
        distance: 8.5,
        workout: {
            warmup: { time: 600 },
    ...
    // -------------------- SUN (BIKE) --------------------
    {
        ...
        description: "Bike: 60 min @ 75% FTP.",
        duration: 3600,
        workout: {
            main: {
                time: 3600,
    ...
    // -------------------- SUN (RUN) --------------------
    {
        ...
        description: "Run: 15 min @ 4:40/km.",
        duration: 900,
        workout: {
            main: {
                time: 900,
    ...
    // -------------------- MON --------------------
    {
        ...
        completed: false,
        title: "Swim Tech",
        description: "8x25m Zipper Drill. 6x100m gebroken.",
        duration: 2400,
        distance: 1,
        workout: {
            warmup: { distance: 100 },
            ...
            main: {
                ...
                sets: 6,
                RPE: 7,
                description: "Gebroken als 4x25m met 10' rust",
            },
        },
    } as ISwimWorkout,
    ...
    // -------------------- WED (RUN) --------------------
    {
        ...
        completed: false,
        title: "Key Session: Run Intervals",
        description: "3x2km @ 4:15/km (rec: 3' jog).",
        duration: 3000,
        workout: {
            warmup: { time: 900 },
            main: {
    ...
    // -------------------- WED (BIKE) --------------------
    {
        ...
        type: "Bike",
        completed: false,
        title: "Key Session: Threshold Intervals",
        description: "3x8 min @ 95–100% FTP.",
        duration: 3000,
        workout: {
            warmup: { time: 600 },
            main: {
    ...
    // -------------------- FRI --------------------
    {
        ...
        completed: false,
        title: "Swim Strength",
        description: "4x50m Sculling. 8x75m (25 drill/50 swim).",
        duration: 2700,
        distance: 1.0,
        workout: {
            warmup: { distance: 150 },
            ...
            main: {
                ...
                sets: 8,
                RPE: 7,
                description: "25m drill / 50m swim met pull-buoy",
            },
        },
    } as ISwimWorkout,
    ...
    // -------------------- SUN --------------------
    {
        ...
        type: "Run",
        completed: false,
        title: "Key Session: Long Run",
        description: "14 km @ 5:20/km (Steady Z2).",
        duration: 4500,
        distance: 14.0,
        workout: {
            main: {
    ...
    // -------------------- MON --------------------
    {
        ...
        completed: false,
        title: "Swim Tech",
        description: "8x25m Sighting drills. 10x50m @ RPE 8.",
        duration: 2400,
        distance: 0.8,
        workout: {
            warmup: { distance: 100 },
    ...
    // -------------------- WED (RUN) --------------------
    {
        ...
        completed: false,
        title: "Key Session: Run Intervals",
        description: "10x400m @ 4:00/km (rec: 1' jog).",
        duration: 2700,
        workout: {
            warmup: { time: 600 },
            main: {
    ...
    // -------------------- WED (BIKE – OVER/UNDER) --------------------
    {
        ...
        type: "Bike",
        completed: false,
        title: "Key Session: Over-Under Session",
        description: "3 sets van (2 min @ 95% + 2 min @ 105% FTP).",
        duration: 2700,
        workout: {
            warmup: { time: 600 },
            main: {
                sets: 3,
                description: "2 min @ 95% + 2 min @ 105% FTP",
                on: {
                    time: 120,
                    watts: "105% FTP",
                },
    ...
    // -------------------- FRI --------------------
    {
        ...
        completed: false,
        title: "Swim Endurance",
        description: "6x50m (25m Fist / 25m Free). 4x200m @ RPE 7.",
        duration: 2700,
        distance: 1.2,
        workout: {
            warmup: { distance: 100 },
            ...
            main: {
                ...
                RPE: 7,
                rest: 30,
                description: "Freestyle met pull-buoy",
            },
        },
    } as ISwimWorkout,
    ...
    // WEEK 4 — Specific Power & Tempo (26/01/2026 - 01/02/2026)
    {
        ...
        title: "Swim Tech",
        description: "8x25m 6-1-6 rotation focus. 12x50m @ RPE 7.",
        duration: 2400, distance: 0.9,
        workout: {
            warmup: { distance: 100 },
            drill: { distance: 25, drill: "6-1-6 rotation", sets: 8 },
    ...
    } as IRunWorkout,
    {
        ...
        title: "Key Session: VO2 Max Boost",
        description: "5x3 min @ 110% FTP (HR Z5, rec: 3' Z1).",
        duration: 2700,
        workout: {
            warmup: { time: 600 },
            main: { time: 180, sets: 5, watts: "110% FTP", rest: 180 },
            coolDown: { time: 300 }
        }
    } as IBikeWorkout,
    {
    ...
    } as ISoccerWorkout,
    {
        ...
        type: "Swim", completed: false,
        title: "Swim Strength",
        description: "6x50m (25m Sighting / 25m Free). 15x50m met pull-buoy.",
        duration: 2700, distance: 1.25,
        workout: {
            warmup: { distance: 150 },
            drill: { distance: 50, drill: "25m Sighting / 25m Free", sets: 6 },
    ...
    },
    {
        ...
        type: "Run", completed: false,
        title: "Key Session: Long Run",
        description: "16 km @ 5:15/km.",
        duration: 5100, distance: 16.0,
        workout: {
            main: { distance: 16000, pace: "5:15/km" }
        }
    } as IRunWorkout,
    ...
    // WEEK 5 — Performance Peak (02/02/2026 - 08/02/2026)
    {
        ...
        type: "Swim", completed: false,
        title: "Swim Tech",
        description: "4x50m Single Arm. 6x100m @ RPE 8.",
        duration: 2700, distance: 1.0,
        workout: {
            warmup: { distance: 100 },
            drill: { distance: 50, drill: "Single Arm", sets: 4 },
    ...
    },
    {
        ...
        type: "Run", completed: false,
        title: "Key Session: Run Quality",
        description: "6km @ 4:25/km + 2x1km @ 4:05/km.",
        duration: 3600,
        workout: {
            warmup: { time: 900 },
            main: { description: "6km @ 4:25 + 2x1km @ 4:05" },
            coolDown: { time: 600 }
        }
    } as IRunWorkout,
    {
    ...
    // WEEK 6 — Maximale Adaptatie (09/02/2026 - 15/02/2026)
    {
        ...
        type: "Swim", completed: false,
        title: "Swim Tech",
        description: "6x50m Catch-up. 10x50m FAST @ RPE 9.",
        duration: 2700, distance: 0.9,
        workout: {
            warmup: { distance: 100 },
            drill: { distance: 50, drill: "Catch-up (DPS focus)", sets: 6 },
    ...
    } as IRunWorkout,
    {
        day: "Wed", date: "11", fullDate: "2026-02-11",
        type: "Bike", completed: false,
        title: "Key Session: Peak Over-Unders",
        description: "4 sets van (2 min @ 95% / 2 min @ 110% FTP).",
        duration: 2700,
        workout: {
            warmup: { time: 600 },
    ...
    },
    {
        ...
        type: "Swim", completed: false,
        title: "Swim Strength",
        description: "4x50m Sculling. 400m non-stop Tijdrit.",
        duration: 3000, distance: 0.7,
        workout: {
            warmup: { distance: 100 },
            drill: { distance: 50, drill: "Sculling", sets: 4 },
    ...
    {
        day: "Mon", date: "16", fullDate: "2026-02-16",
        type: "Swim", completed: false,
        title: "Swim (EZ)",
        description: "Drills only (EZ).",
        duration: 1500, distance: 0.5,
        workout: {
            warmup: { distance: 100 },
            drill: { distance: 50, drill: "EZ", sets: 10 },
            main: { distance: 500, description: "Drills only EZ" },
            coolDown: { distance: 100 }
        }
    } as ISwimWorkout,
    {
        day: "Tue", date: "17", fullDate: "2026-02-17",
        type: "Soccer", completed: false,
        title: "Soccer Practice",
        description: "Regular training session.",
        duration: 5400
    },
    {
        ...
        description: "2x1km @ 4:15/km.",
        duration: 1800,
        workout: {
            warmup: { time: 600 },
            main: { distance: 1000, sets: 2, pace: "4:15/km" },
            coolDown: { time: 300 }
        }
    } as IRunWorkout,
    {
        ...
        description: "3x3 min @ 100% FTP (Openers).",
        duration: 1500,
        workout: {
            warmup: { time: 600 },
            main: { time: 180, sets: 3, watts: "100% FTP" },
            coolDown: { time: 360 }
        }
    } as IBikeWorkout,
    {
        day: "Thu", date: "19", fullDate: "2026-02-19",
        type: "Soccer", completed: false,
        title: "Soccer Practice",
        description: "Regular training session.",
        duration: 5400
    },
    {
        ...
        title: "Swim (EZ)",
        description: "400m EZ.",
        duration: 1500, distance: 0.4,
        workout: {
            main: { distance: 400, description: "EZ" }
        }
    } as ISwimWorkout,
    {
        day: "Sat", date: "21", fullDate: "2026-02-21",
        type: "Soccer", completed: false,
        title: "Soccer Match",
