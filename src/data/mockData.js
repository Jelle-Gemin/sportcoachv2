...
export const weeklySchedule = [
    ...
    { day: "Mon", date: "05", fullDate: "2026-01-05", type: "Strength", completed: true, title: "Kracht (Efficiency A)", description: "Pull-ups, DB Bench, Ab Wheel.", duration: 1200, workout: { main: { sets: 2, exercises: ["Pull-up (Max reps)", "DB Bench Press (14.5kg, 15-20 reps)", "Ab Wheel Rollout (12 reps)"] } } },
    ...
    { day: "Fri", date: "09", fullDate: "2026-01-09", type: "Strength", completed: true, title: "Kracht (Efficiency B)", description: "Bulgarian Split Squat, DB RDL, Weighted Plank.", duration: 1200, workout: { main: { sets: 2, exercises: ["Bulgarian Split Squat (15 reps)", "DB Romanian Deadlift (15-20 reps)", "Weighted Plank (60 sec)"] } } },
    ...
    { day: "Fri", date: "16", fullDate: "2026-01-16", type: "Strength", completed: false, title: "Kracht B", description: "Focus on control with Romanian Deadlifts.", duration: 1200 },
    ...
    { day: "Mon", date: "19", fullDate: "2026-01-19", type: "Strength", completed: false, title: "Kracht A", description: "2 sets tot falen (Schoenfeld protocol).", duration: 1200 },
    ...
    { day: "Fri", date: "23", fullDate: "2026-01-23", type: "Strength", completed: false, title: "Kracht B", description: "Bulgarian Split Squats tot absoluut falen.", duration: 1200 },
    { day: "Fri", date: "23", fullDate: "2026-01-23", type: "Swim", completed: false, title: "Swim Endurance", description: "6x50m (25m Fist / 25m Free). 4x200m @ RPE 7.", duration: 2700, distance: 1.2, workout: { warmup: { distance: 100 }, drill: { distance: 50, drill: "25m Fist / 25m Free", sets: 6 }, main: { distance: 200, sets: 4, RPE: 7, rest: 30, description: "met pull-buoy" } } },
    ...
    { day: "Mon", date: "26", fullDate: "2026-01-26", type: "Strength", completed: false, title: "Kracht A", description: "Focus on explosivity in the concentric phase.", duration: 1200 },
    ...
    { day: "Fri", date: "30", fullDate: "2026-01-30", type: "Strength", completed: false, title: "Kracht B", description: "15-30 reps for maximal metabolic stress.", duration: 1200 },
    ...
    { day: "Mon", date: "02", fullDate: "2026-02-02", type: "Strength", completed: false, title: "Kracht A", description: "Minimal session: 1 set to failure per exercise.", duration: 900 },
    ...
    { day: "Fri", date: "06", fullDate: "2026-02-06", type: "Strength", completed: false, title: "Kracht B", description: "Maintain intensity, minimize volume.", duration: 900 },
    ...
    { day: "Mon", date: "09", fullDate: "2026-02-09", type: "Strength", completed: false, title: "Kracht A", description: "Laatste zware prikkel voor deload.", duration: 1200 },
